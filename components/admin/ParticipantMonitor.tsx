                ...
                return (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={`h-2 w-2 rounded-full shrink-0 ${
                            DIFF_COLORS[r.problem_difficulty ?? 0] ||
                            "bg-slate-500"
                          }`}
                        />
                    ...
                    <td className="px-4 py-3 text-center text-slate-400 text-xs">
                      {r.elapsed_minutes < 60
                        ? `${r.elapsed_minutes}m`
                        : `${Math.floor(r.elapsed_minutes / 60)}h ${
                            r.elapsed_minutes % 60
                          }m`}
                    </td>
                    ...
                    <td className="px-4 py-3 text-center">
                      <span
                        className={`inline-flex items-center gap-1.5 text-xs font-medium ${st.color}`}
                      >
                        <span
