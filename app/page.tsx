...
export default function Home() {
    ...
    <div className="min-h-screen bg-[#030712] text-white overflow-x-hidden">
      ...
      <section className="relative z-10 flex min-h-[92vh] flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <p className="animate-fade-in-up animation-delay-100 mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-slate-400 md:text-xl">
          Compete in live React challenges, get your code scored by Gemini AI
          across 5 categories, pair-program with an AI coach, and climb the
          global leaderboard — all in your browser.
        </p>
  ...
  return (
    <div className="p-6 max-w-md mx-auto">
          ...
          <div className="border-t border-white/6 bg-[#161b22]/80 px-4 py-2.5 flex items-center gap-3">
            ...
            <div className="flex gap-1 ml-auto">
              {[82, 90, 75, 88, 79].map((v, i) => (
                <div
                  key={i}
                  className="h-1 rounded-full bg-violet-500/60"
                  style={{ width: `${v * 0.3}px` }}
                />
              ))}
            </div>
          </div>
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {[
              ...
              {
                value: "30",
                label: "Second AI Coaching Sessions",
                suffix: "s",
              },
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            ...
            <p className="mt-4 text-slate-400 max-w-xl mx-auto">
              Built for serious developers who want to compete, learn, and grow
      ...
      <section
        id="how-it-works"
        className="relative z-10 py-24 px-6 bg-linear-to-b from-transparent via-violet-950/10 to-transparent"
      >
      ...
      <section className="relative z-10 py-24 px-6">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-slate-400 max-w-xl mx-auto">
              Every submission is judged across five weighted categories. No
              black box — you see exactly why you scored what you scored.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/8 bg-white/3 p-8">
              ...
              {[
                {
                  ...
                  score: 88,
                  color: "bg-violet-500",
                  desc: "State design, component hierarchy, separation of concerns",
                },
                {
                  label: "Hooks & State Usage",
                  score: 92,
                  color: "bg-indigo-500",
                  desc: "Correct use of useState, useEffect, useCallback, custom hooks",
                },
                {
                  label: "Code Quality",
                  score: 79,
                  color: "bg-cyan-500",
                  desc: "Readability, naming, TypeScript types, no dead code",
                },
                {
                  label: "Functionality",
                  score: 95,
                  color: "bg-emerald-500",
                  desc: "Does the component actually work as specified?",
                },
                {
                  label: "Accessibility",
                  score: 71,
                  color: "bg-amber-500",
                  desc: "ARIA attributes, keyboard navigation, semantic HTML",
                },
            ...
            <div className="mt-6 flex items-center justify-between border-t border-white/8 pt-5">
              ...
              <span className="text-2xl font-extrabold text-white">
                85<span className="text-violet-400">/100</span>
              </span>
            </div>
          </div>
        </div>
      ...
      <section
        id="leaderboard"
        className="relative z-10 py-24 px-6 bg-linear-to-b from-transparent via-indigo-950/10 to-transparent"
      >
        <div className="mx-auto max-w-3xl">
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-slate-400">
              Compete against others and watch your rank update in real-time.
            </p>
          </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-white/8 bg-white/3">
            ...
            {[
              ...
              <div
                key={rank}
                className="flex items-center gap-4 px-6 py-4 border-b border-white/4 last:border-0 hover:bg-white/2 transition group"
              >
        ...
        <div className="mx-auto max-w-3xl text-center">
          <div className="relative overflow-hidden rounded-3xl border border-violet-500/20 bg-linear-to-br from-violet-900/30 via-indigo-900/20 to-slate-900/30 p-12 backdrop-blur shadow-2xl shadow-violet-500/10">
            ...
            <p className="mx-auto mb-8 max-w-md text-slate-400">
              No setup. No signup. Just open the arena, type your name, and
              start building. Your AI judge is waiting.
            </p>
            <Link
              href="/sandbox"
      ...
      <footer className="relative z-10 border-t border-white/5 py-10 px-6 text-center text-sm text-slate-600">
        <div className="mx-auto max-w-6xl flex flex-col items-center gap-3 md:flex-row md:justify-between">
          <div className="flex items-center gap-2 text-slate-500">
            <div className="flex h-6 w-6 items-center justify-center rounded-md bg-linear-to-br from-violet-500 to-indigo-600 text-xs">
              ⚛
            </div>
            <span className="font-semibold text-slate-400">AuraCode</span>
          </div>
          <p className="text-slate-600">
            AI-powered competitive coding — built for the next generation of
            developers.
          </p>
